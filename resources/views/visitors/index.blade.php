...
<head>
    ...
    <meta name="description"
        content="Discover how we help individuals, families, institutions and governments raise, manage and distribute the capital they need to achieve their goals.">
...
<body>
    ...
    <section class="menu menu2 cid-st9UetCg9i" once="menu" id="menu2-k">
        ...
        <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
            <div style="padding: 0; margin-left: -2px; width: 100vw; border: transparent;">
                ...
                <coingecko-coin-price-marquee-widget coin-ids="bitcoin,eos,ethereum,litecoin,ripple,usd-coin"
                    currency="usd" background-color="#ffffff" locale="en"
                    font-color="steelblue"></coingecko-coin-price-marquee-widget>
            </div>
            <div class="container-fluid">
                <div class="navbar-brand">
                    <span class="navbar-logo">
                        <a href="index.html">
                            <img src="{{asset('assets/images/logo.png')}}" alt="Easybe style=" height: 2rem;">
                        </a>
                    </span>
                    <span class="navbar-caption-wrap"><a class="navbar-caption text-black display-7"
                            href="index.html">Bingx Finance</a></span>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                        ...
                        <li class="nav-item dropdown"><a class="nav-link link text-black dropdown-toggle display-4"
                                href="services.html" data-toggle="dropdown-submenu" aria-expanded="false">Sector</a>
                            <div class="dropdown-menu"><a class="text-black dropdown-item display-4"
                                    href="real-estate.html">Real Estate</a><a class="text-black dropdown-item display-4"
                                    href="financial-services.html" aria-expanded="false">Financial Services</a><a
                                    class="text-black dropdown-item display-4" href="cryptocurrency.html"
                                    aria-expanded="false">cryptocurrency</a><a
                                    class="text-black dropdown-item display-4" href="health-care.html"
                                    aria-expanded="false">Health Care</a><a class="text-black dropdown-item display-4"
                                    href="information-technology.html" aria-expanded="false">Infomation technology</a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item"><a class="nav-link link text-black display-4"
                                href="investing.html">Investing</a>
                        </li>
            ...
            <div class="row" style="color: #fff;">
                <div class="col-12 col-lg-7">
                    ...
                    <div class="mbr-section-btn mt-3"><br><br><br>
                        ...
                        <a class="btn btn-success-outline display-4" href="services.html">our services &gt;</a>
                    </div>
                </div>
            </div>
        </div>
         ...
         <div class="row">
          ...
          <div class="col-md-4">
           <div class="card card-body">
            ...
            <p class="card-text">
             Go long or short on FX from just 1 pip. Trade commodities and indices with
                                 flexible leverage.
            </p>
            <a href="https://stockaccess.io/register" style="width: fit-content;">
             Trade Now
         ...
         <div class="row" style="margin-top: 100px;">
          <div class="col-md-6">
           <h2>
            ...
            in top stocks and ETFs. Trade currency pairs, Indices and Commodities
           ...
           <div style="border-left: 1px solid black;margin-top: 40px;padding: 15px;">
            <h1 id="demo" style="color: green;font-size: 70px;font-weight: 800;">85,242,817</h1>
            <h6>
             TRADES OPENED ON STOCK ACCESS
            </h6>
            <script>
          ...
          <div class="col-md-6">
           ...
           <div class="tradingview-widget-container" id="widget1" style="margin-bottom: 3px; width: 100%; height: 249px;">
            <iframe allowtransparency="true" frameborder="0" lang="en" scrolling="no" src="https://s.tradingview.com/embed-widget/symbol-info/?locale=en&amp;symbol=NASDAQ%3ATSLA#%7B%22symbol%22%3A%22NASDAQ%3ATSLA%22%2C%22width%22%3A%22100%25%22%2C%22colorTheme%22%3A%22light%22%2C%22isTransparent%22%3Afalse%2C%22height%22%3A205%2C%22utm_source%22%3A%22stockaccess.io%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22symbol-info%22%2C%22page-uri%22%3A%22stockaccess.io%2F%22%7D" style="user-select: none; box-sizing: border-box; display: block; height: 249px; width: 100%;" title="symbol info TradingView widget">
            </iframe>
            <style>
           ...
           <!-- TradingView Widget BEGIN -->
           <div class="tradingview-widget-container" id="widget2" style="margin-bottom: 3px; width: 100%; height: 249px;">
            <iframe allowtransparency="true" frameborder="0" lang="en" scrolling="no" src="https://s.tradingview.com/embed-widget/symbol-info/?locale=en&amp;symbol=NASDAQ%3AAAPL#%7B%22symbol%22%3A%22NASDAQ%3AAAPL%22%2C%22width%22%3A%22100%25%22%2C%22colorTheme%22%3A%22light%22%2C%22isTransparent%22%3Afalse%2C%22height%22%3A205%2C%22utm_source%22%3A%22stockaccess.io%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22symbol-info%22%2C%22page-uri%22%3A%22stockaccess.io%2F%22%7D" style="user-select: none; box-sizing: border-box; display: block; height: 249px; width: 100%;" title="symbol info TradingView widget">
            </iframe>
            <style>
             .tradingview-widget-copyright {
                                     font-size: 13px !important;
           ...
           <!-- TradingView Widget END -->
           <!-- TradingView Widget BEGIN -->
           <div class="tradingview-widget-container active6" id="widget3" style="margin-bottom: 3px; width: 100%; height: 273px;">
            <iframe allowtransparency="true" frameborder="0" lang="en" scrolling="no" src="https://s.tradingview.com/embed-widget/symbol-info/?locale=en&amp;symbol=NASDAQ%3AAMZN#%7B%22symbol%22%3A%22NASDAQ%3AAMZN%22%2C%22width%22%3A%22100%25%22%2C%22colorTheme%22%3A%22light%22%2C%22isTransparent%22%3Afalse%2C%22height%22%3A205%2C%22utm_source%22%3A%22stockaccess.io%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22symbol-info%22%2C%22page-uri%22%3A%22stockaccess.io%2F%22%7D" style="user-select: none; box-sizing: border-box; display: block; height: 273px; width: 100%;" title="symbol info TradingView widget">
            </iframe>
            <style>
             .tradingview-widget-copyright {
                                     font-size: 13px !important;
           ...
           <!-- TradingView Widget END -->
           <!-- TradingView Widget BEGIN -->
           <div class="tradingview-widget-container active6" id="widget4" style="margin-bottom: 3px; width: 100%; height: 273px;">
            <iframe allowtransparency="true" frameborder="0" lang="en" scrolling="no" src="https://s.tradingview.com/embed-widget/symbol-info/?locale=en&amp;symbol=NASDAQ%3AMSFT#%7B%22symbol%22%3A%22NASDAQ%3AMSFT%22%2C%22width%22%3A%22100%25%22%2C%22colorTheme%22%3A%22light%22%2C%22isTransparent%22%3Afalse%2C%22height%22%3A205%2C%22utm_source%22%3A%22stockaccess.io%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22symbol-info%22%2C%22page-uri%22%3A%22stockaccess.io%2F%22%7D" style="user-select: none; box-sizing: border-box; display: block; height: 273px; width: 100%;" title="symbol info TradingView widget">
            </iframe>
            <style>
             .tradingview-widget-copyright {
                                     font-size: 13px !important;
           ...
           <!-- TradingView Widget END -->
           <!-- TradingView Widget BEGIN -->
           <div class="tradingview-widget-container" id="widget5" style="margin-bottom: 3px; width: 100%; height: 249px;">
            <iframe allowtransparency="true" frameborder="0" lang="en" scrolling="no" src="https://s.tradingview.com/embed-widget/symbol-info/?locale=en&amp;symbol=NASDAQ%3ANFLX#%7B%22symbol%22%3A%22NASDAQ%3ANFLX%22%2C%22width%22%3A%22100%25%22%2C%22colorTheme%22%3A%22light%22%2C%22isTransparent%22%3Afalse%2C%22height%22%3A205%2C%22utm_source%22%3A%22stockaccess.io%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22symbol-info%22%2C%22page-uri%22%3A%22stockaccess.io%2F%22%7D" style="user-select: none; box-sizing: border-box; display: block; height: 249px; width: 100%;" title="symbol info TradingView widget">
            </iframe>
            <style>
             .tradingview-widget-copyright {
                                     font-size: 13px !important;
           ...
           <!-- TradingView Widget END -->
           <!-- TradingView Widget BEGIN -->
           <div class="tradingview-widget-container" id="widget6" style="margin-bottom: 3px; width: 100%; height: 273px;">
            <iframe allowtransparency="true" frameborder="0" lang="en" scrolling="no" src="https://s.tradingview.com/embed-widget/symbol-info/?locale=en&amp;symbol=NASDAQ%3AFB#%7B%22symbol%22%3A%22NASDAQ%3AFB%22%2C%22width%22%3A%22100%25%22%2C%22colorTheme%22%3A%22light%22%2C%22isTransparent%22%3Afalse%2C%22height%22%3A205%2C%22utm_source%22%3A%22stockaccess.io%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22symbol-info%22%2C%22page-uri%22%3A%22stockaccess.io%2F%22%7D" style="user-select: none; box-sizing: border-box; display: block; height: 273px; width: 100%;" title="symbol info TradingView widget">
            </iframe>
            <style>
             .tradingview-widget-copyright {
                                     font-size: 13px !important;
            ...
            <div class="row mt-4">
                <div class="item features-image сol-12 col-md-6 col-lg-4">
                    <div class="item-wrapper">
                        ...
                        <div class="mbr-section-btn item-footer mt-2"><a href="register.html"
                                class="btn item-btn btn-black display-7" target="_blank">Get Started
                                &gt;</a></div>
                    </div>
                </div>
                <div class="item features-image сol-12 col-md-6 col-lg-4">
    ...
    <section class="features16 cid-st9V6PUf1U" id="features17-r">
                    ...
                    <div class="col-12 col-lg">
                        <div class="text-wrapper">
                            <h6 class="card-title mbr-fonts-style display-5">
                                <strong>Trade and Withdraw With <strong style="color: #d4b218;">Bingx 
                                        Finance's</strong> MasterCard</strong>
                            </h6>
                            <br><br>
                            <div class="mbr-section-btn">
                                <a class="btn btn-primary display-4" href="register.html">Start now</a>
    ...
    <section class="features1 cid-stl9SwFQHK" id="features1-1m" style="background: steelblue">



        <div class="container">
            <div class="mbr-section-head">
                <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2"><strong>Why Choose Easybe
                        Investment Benefit</strong></h4>
                <h5 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-2 display-5">We have a unique
                    approach to income generation. We build innovative wealth creation products.</h5> <br>
            </div>
            <div class="row">
                ...
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper">
                        <div class="card-box align-center">
                            ...
                            <h5 class="card-title mbr-fonts-style display-7"><strong>Investment access</strong></h5>
                            <p class="card-text mbr-fonts-style display-7">We took a look at the typical investor
                                journey and knew something had to change. We are creating a fundamental paradigm shift
                                by providing investors access to investments previously available to the top 1%.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper">
                        <div class="card-box align-center">
                            ...
                            <h5 class="card-title mbr-fonts-style display-7"><strong>Asset protection</strong></h5>
                            <p class="card-text mbr-fonts-style display-7">All sites you create with
                                Asset protection
                                With our Customer Protection Guarantee, we reimburse you for losses from unauthorized
                                activity in your accounts. We also participate in asset protection programs.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper">
                        <div class="card-box align-center">
                            <div class="iconfont-wrapper">
                                <span class="mbr-iconfont mobi-mbri-protect theme-2 mobi-mbri"></span>
                            </div>
                            <h5 class="card-title mbr-fonts-style display-7"><strong>Security & Privacy</strong></h5>
                            <p class="card-text mbr-fonts-style display-7">We understand the importance when it comes to
                                the security of your family and your assets. That's why we use the latest technology to
                                help protect your personal information and financial transactions.</p>
                        </div>
                    </div>
                </div>
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper">
                        <div class="card-box align-center">
                            ...
                            <h5 class="card-title mbr-fonts-style display-7"><strong>We are pioneersin mordern
                                    investment </strong></h5>
                            <p class="card-text mbr-fonts-style display-7">We’re early industry pioneers and have been
                                around since 2011, successfully processed more than 800 million dollars in transactions
                                and available in over 40 countries.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="features12 cid-sbjC4xk2AM" id="features13-d">
                    ...
                    <div class="card-wrapper">
                        <div class="card-box align-left">
                            <h4 class="card-title mbr-fonts-style mb-4 display-2">
                                <strong>How to get started with your first Investment Strategy.</strong>
                            </h4>
                ...
                <div class="col-12 col-lg-6">
                    <div class="item mbr-flex">
                        ...
                        <div class="text-box">
                            ...
                            <h5 class="icon-text mbr-black mbr-fonts-style display-4">Go to the <strong
                                    style="color: steelblue;">sign up</strong> page, complete the form and click on the
                                submit button, make sure you use a <strong style="color: steelblue;">strong
                                    password.</strong>
                            </h5>
                        </div>
                    </div>
                    <div class="item mbr-flex">
                        ...
                        <div class="text-box">
                            <h4 class="icon-title mbr-black mbr-fonts-style display-7">
                                <strong>Choose an Investment Strategy</strong>
                            </h4>
                            <h5 class="icon-text mbr-black mbr-fonts-style display-4">After you <strong
                                    style="color: steelblue;"> signed up</strong> you will use your details log in into
                                your dashboard use the hand burger menu to navigate to the<strong
                                    style="color: steelblue;"> invest section </strong>and choose an <strong
                                    style="color:steelblue;">Investment Strategy.</strong></h5>
                        </div>
                    </div>
                    <div class="item mbr-flex">
                        <div class="icon-box">
                        ...
                        <div class="text-box">
                            ...
                            <h5 class="icon-text mbr-black mbr-fonts-style display-4">After Choosing an Investment
                                Strategy you would need to make a payment to Bitcoin Address given and complete the
                                transaction, <strong style="color: steelblue;">this address expires in 6 minutes</strong>
                                so make sure you make the payment and complete the transaction, this will prevent
                                technical issues.</h5>
                        </div>
                    </div>
                    <div class="item mbr-flex">
                        ...
                        <div class="text-box">
                            ...
                            <h5 class="icon-text mbr-black mbr-fonts-style display-4">During this process your payment
                                is verified and you should start making profit.</h5>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- <section class="">
        ...
        <!-- <iframe width="100%" height="500" src="https://www.youtube.com/embed/3DwBHpeTy1M?si=UNibwvEFp5496NG2"
    ...
    <section class="info3 cid-st9YwYUKSr" id="info3-1j">
                    ...
                    <div class="card-wrapper">
                        <div class="card-box align-center">
                            <h4 class="card-title mbr-fonts-style align-center mb-4 display-2">
                                <strong>Let Us Work For You</strong>
                            </h4>
                            <p class="mbr-text mbr-fonts-style mb-4 display-7">
    ...
    <section class="pricing-area bg-f9f9f9 pt-100 pb-70 " style="padding:1rem 0; font-family: sans-serif;">
        <div class="container">
            <div class="section-title" style="margin:1rem 0,">
                <h2 style="font-size: 30px; margin:1rem 0;text-align: center;">
                    Recent Verified Deposits
                </h2>
                <p>
                    Below is a live update of Recent Deposits from our clients.
                </p>
            </div>
            <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="color-secondary">
                                    ...
                                    <span class="name">Name Placeholder</span> <!-- Updated class for name -->
                                </td>
                                <td class="amount">Amount Placeholder</td> <!-- Updated class for amount -->
                            </tr>
                            <tr>
                                <td class="color-secondary">
                                    <span class="ti-check-box mr-2 color-secondary"></span>
                            ...
                            <!-- Repeat the above <tr>...</tr> block for the number of rows you need -->
                        </tbody>
                    </table>
                </div>
    ...
    <script src="https://easybeee.com/widgets.coingecko.com/coingecko-coin-price-marquee-widget.html"></script>
    <coingecko-coin-price-marquee-widget coin-ids="bitcoin,ethereum,eos,ripple,litecoin" currency="usd"
        background-color="#444444" locale="en" font-color="#c0c0c0"></coingecko-coin-price-marquee-widget>
        ...
        <div class="container">
            <div class="row mbr-white">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <ul class="list mbr-fonts-style display-4">
                        <a href="privacy-policy.html" class="mbr-text item-wrap"> <span
                                style="color: steelblue;">&gt;</span> Privacy policy</a><br>
                        <a href="term-and-condition.html" class="mbr-text item-wrap"> <span
                                style="color: steelblue;">&gt;</span> Terms and condition</a><br>
                        <a href="refund-policy.html" class="mbr-text item-wrap"><span
                                style="color: steelblue;">&gt;</span> Refund policy</a><br>
                    </ul>
                </div>
                <div class="col-12 col-md-6 col-lg-3">
                    <h5 class="mbr-section-subtitle mbr-fonts-style mb-2 display-7">
    ...
    <section
        ...
        <p style="flex: 0 0 auto; margin:0; padding-right:1rem;"><a href="https://mobirise.site/c"
                style="color:#aaa;">The</a> web page was built with Mobirise</p>
    </section>
