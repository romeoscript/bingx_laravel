                     ...
                     <div class="col-12 col-lg-6">
                            <div class="item mbr-flex">
                                   ...
                                   <div class="text-box">
                                          ...
                                          <h5 class="icon-text mbr-black mbr-fonts-style display-4">Go to the <strong style="color: steelblue;">sign up</strong> page, complete the form and click on the
                            ...
                            <div class="item mbr-flex">
                                   ...
                                   <div class="text-box">
                                          ...
                                          <h5 class="icon-text mbr-black mbr-fonts-style display-4">After you <strong style="color: steelblue;"> signed up</strong> you will use your details log in into
                                                 your dashboard use the hand burger menu to navigate to the<strong style="color: steelblue;"> invest section </strong>and choose an <strong style="color:steelblue;">Investment Strategy.</strong></h5>
                                   </div>
                            </div>
                            <div class="item mbr-flex">
                                   <div class="icon-box">
...
<coingecko-coin-price-marquee-widget coin-ids="bitcoin,ethereum,eos,ripple,litecoin" currency="usd" background-color="#444444" locale="en" font-color="#c0c0c0"></coingecko-coin-price-marquee-widget>
