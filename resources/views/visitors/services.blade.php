...
<section class="header13 cid-stnA7eA40o" id="header13-1n">
    ...
    <div class="align-center container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-10" style="color: white;">
                <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>Our
                    Services
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="image-wrapper">
                        <img src="bingx/assets/images/wealth.jpg" alt="Mobirise">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="content-wrapper">
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="image-wrapper">
                        <img src="bingx/assets/images/trade.jpg" alt="Mobirise">
                    </div>
                </div>
                <div class="col-12 col-lg">
                    <div class="text-wrapper">
                        ...
                        <p class="mbr-text mbr-fonts-style mb-4 display-4">
                            Global institutions, leading hedge funds and industry innovators turn to Lincon Finance for sales, trading and market-making services.</p>
                        <div class="mbr-section-btn mt-3">
                            <a class="btn btn-primary display-4" href="{{route('register')}}">
                                Learn more
                            </a>
...
</section><section class="features15 cid-st9Vg8Xhek" id="features16-v">
    ...
    <div class="container">
        <div class="content-wrapper">
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="image-wrapper">
                        <img src="bingx/assets/images/loan.jpg" alt="Mobirise">
                    </div>
                </div>
                <div class="col-12 col-lg">
                    <div class="text-wrapper">
                        <h6 class="card-title mbr-fonts-style display-5">
                            <strong>WEALTH LENDING</strong>
                        </h6>
                        <p class="mbr-text mbr-fonts-style mb-4 display-4">
