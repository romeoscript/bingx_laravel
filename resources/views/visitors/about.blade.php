...
@section('body')
<section class="header6 cid-st9Y6ORgVm" id="header6-1f">
...
<div class="align-center container-fluid">
    <div class="row justify-content-center">
        <div class="col-12 col-lg-8">
            <h1 class="mbr-section-title mbr-fonts-style mbr-white mb-3 display-2"><strong>We move, lend, <strong style="color: steelblue;">invests</strong> and protect money for customers and clients worldwide</strong></h1>
            ...
            <div class="col-12 col-lg">
                <div class="text-wrapper">
                    ...
                    <p class="mbr-text mbr-fonts-style mb-4 display-4">
                        ...
                        <br><br>
                        Our mission is to generate world-class investment returns over the long term. We aspire to do so in a way that makes our partners and portfolio companies proud, as we build a unique, global investment company.</p>
...
<section class="features16 cid-st9VgsXZ4c" id="features17-w">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg">
                <div class="text-wrapper">
                    ...
                    <p class="mbr-text mbr-fonts-style mb-4 display-4">
                        Our common Purpose is ‘Creating opportunities to rise’. We are a company of opportunity makers working together to help people rise – customers, clients, colleagues and society.</p>
                    <div class="mbr-section-btn mt-3">
                        <a class="btn btn-primary display-4" href="{{route('services')}}">
                            Learn more
                        </a>
...
<div class="align-center container">
    <div class="row justify-content-center">
        <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
            <form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="RLGH2esOy+3AigwOcc9nrcHbrtMNKb/anEaRPCkArE8iZWkFi6E5nDFK7imokjezoedHUSKzV3aHcB6IVEeugXhO90nD4ko/8Tg858sBwy3j9FmOEDjpLpYsVmO1it6X">
                <div class="row">
